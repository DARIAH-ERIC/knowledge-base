...
export function EmptyState(props: Readonly<EmptyStateProps>): ReactNode {
	...
	return (
		<div
			aria-hidden={true}
			className={cn("relative flex h-72 items-center justify-center md:h-100", className)}
		>
			<div
				aria-hidden={true}
			...
			>
				...
				<svg
					aria-hidden={true}
					className="absolute top-0 -left-10 size-5 text-muted-fg/80"
					fill="none"
					viewBox="0 0 24 24"
					xmlns="http://www.w3.org/2000/svg"
				>
				...
				<svg
					aria-hidden={true}
					className="absolute top-16 -left-20 size-5 text-muted-fg/70"
					fill="none"
					viewBox="0 0 24 24"
					xmlns="http://www.w3.org/2000/svg"
				>
				...
				<svg
					aria-hidden={true}
					className="absolute top-16 -right-24 size-5 text-muted-fg/50"
					fill="none"
					viewBox="0 0 24 24"
					xmlns="http://www.w3.org/2000/svg"
				>
				...
				<svg
					aria-hidden={true}
					className="absolute top-0 left-24 size-5 text-muted-fg/80"
					fill="none"
					viewBox="0 0 24 24"
					xmlns="http://www.w3.org/2000/svg"
				>
				...
				<svg
					aria-hidden={true}
					className="absolute -top-20 -right-20 size-5 text-muted-fg/80"
					fill="none"
					viewBox="0 0 24 24"
					xmlns="http://www.w3.org/2000/svg"
				>
				...
				>
					...
					<path
						...
						fill="currentColor"
					/>
					<path d="M12 10H12.5V9H12V10ZM3.5 9H3V10H3.5V9ZM12 9H3.5V10H12V9Z" fill="currentColor" />
					<path
