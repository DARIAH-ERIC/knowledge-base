...
export function Pagination({ className, ref, ...props }: ComponentProps<"nav">): ReactNode {
	return (
		<nav
...
export function PaginationSection({ className, ref, ...props }: ComponentProps<"ul">): ReactNode {
	return (
...
export function PaginationList({ className, ref, ...props }: ComponentProps<"ul">): ReactNode {
	return (
		<ul
			ref={ref}
...
export function PaginationFirst({
	...
	isCircle,
	...props
}: PaginationAttributesProps): ReactNode {
	return (
		<li>
			<Link
				data-slot="pagination-item"
...
export function PaginationSpacer({ className, ref, ...props }: ComponentProps<"div">): ReactNode {
...
export function PaginationLabel({ className, ref, ...props }: ComponentProps<"li">) {
	return (
		<li
			ref={ref}
...
export function PaginationInfo({ className, ...props }: ComponentProps<"p">) {
	return (
		<p
			className={twMerge(
