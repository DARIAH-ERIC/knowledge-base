...
export const env = validate({
	environment: {
		...
		NEXT_PUBLIC_TYPESENSE_COLLECTION_NAME_RESOURCES:
			process.env.NEXT_PUBLIC_TYPESENSE_COLLECTION_NAME_RESOURCES,
		NEXT_PUBLIC_TYPESENSE_COLLECTION_NAME_WEBSITE:
			process.env.NEXT_PUBLIC_TYPESENSE_COLLECTION_NAME_WEBSITE,
