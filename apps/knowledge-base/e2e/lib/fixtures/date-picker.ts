 ...
 * *previous* segment — potentially escaping the date group entirely and corrupting adjacent
 * fields. To stay scoped, re-click the segment before each backspace and stop as soon as it
 * reads as cleared (aria-valuenow becomes null).
 */
