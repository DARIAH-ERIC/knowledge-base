...
import { deleteDocumentationPageAction } from "@/app/(app)/[locale]/(dashboard)/dashboard/administrator/documentation-pages/_lib/delete-documentation-page.action";
import { useRouter } from "@/lib/navigation/navigation";

interface DocumentationPagesPageProps {
	dir: "asc" | "desc";
	documentationPages: {
		data: Array<
...
export function DocumentationPagesPage(props: Readonly<DocumentationPagesPageProps>): ReactNode {
	const {
		dir: initialDir,
		documentationPages,
		page: initialPage,
	...
	return (
		<Fragment>
			<Header>
				<HeaderContent>
					<HeaderTitle>{t("Documentation pages")}</HeaderTitle>
					<HeaderDescription>
						{t("Manage all documentation pages in the DARIAH knowledge base.")}
					</HeaderDescription>
				</HeaderContent>
				<HeaderAction>
					...
					<Link
						...
						href="/dashboard/website/documentation-pages/create"
					>
			...
			<Paginate
				...
				setPage={setPage}
				total={totalPages}
				totalItems={documentationPages.total}
			/>

			<DeleteModal
				isOpen={itemToDelete != null}
				model={t("documentation page")}
				onAction={() => {
					...
					startDeleteTransition(async () => {
						...
						await deleteDocumentationPageAction(id);
						router.refresh();
