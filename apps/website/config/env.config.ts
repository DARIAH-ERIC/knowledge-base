...
const result = createEnv({
	schemas: {
		...
		private(environment) {
			const schema = v.object({
				...
				WEBSITE_SENTRY_AUTH_TOKEN: v.optional(v.pipe(v.string(), v.nonEmpty())),
			});
		...
		public(environment) {
			const schema = v.object({
				...
				NEXT_PUBLIC_WEBSITE_REDMINE_ID: v.pipe(
					v.string(),
					v.transform(Number),
					v.number(),
					v.integer(),
				...
				NEXT_PUBLIC_WEBSITE_SENTRY_PII: v.optional(v.picklist(["disabled", "enabled"]), "disabled"),
	...
	environment: {
		...
		NEXT_PUBLIC_WEBSITE_MATOMO_ID: process.env.NEXT_PUBLIC_WEBSITE_MATOMO_ID,
		NEXT_PUBLIC_WEBSITE_REDMINE_ID: process.env.NEXT_PUBLIC_WEBSITE_REDMINE_ID,
		NEXT_PUBLIC_WEBSITE_SENTRY_DSN: process.env.NEXT_PUBLIC_WEBSITE_SENTRY_DSN,
		NEXT_PUBLIC_WEBSITE_SENTRY_ORG: process.env.NEXT_PUBLIC_WEBSITE_SENTRY_ORG,
		...
		WEBSITE_SENTRY_AUTH_TOKEN: process.env.WEBSITE_SENTRY_AUTH_TOKEN,
	},
	validation: v.parse(
