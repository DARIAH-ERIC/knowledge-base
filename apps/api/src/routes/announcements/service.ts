 ...
 * consumers rendering one overview page across all three. Featured items are not ranked first:
 * consumers which want them on top merge in `/featured-entities`, as they do for events.
 *
